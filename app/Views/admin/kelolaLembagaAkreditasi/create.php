        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif ?>
                    <form action="/admin/kelola-prodi/tambah" method="POST">
                        <?= csrf_field() ?>
                        <div class="row mb-5 text-start">
                            <div class="col-12 col-lg-6">
                                <label for="nama_jurusan" class="h6">Nama Jurusan </label>
                                <input type="text" class="form-control" id="nama_jurusan" name="jurusan" value="<?= old('jurusan'); ?>" required>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label for="nama_fakultas" class="h6">Nama Fakultas </label>
                                <input type="text" class="form-control" id="nama_fakultas" name="fakultas" value="<?= old('fakultas'); ?>" required>
                            </div>
                        </div>
