        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- form -->
                    <form action="/admin/kriteria-ed/tambah/standar/edit/<?= $uuid ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="row mb-5 text-start">

                            <div class="col-12 col-lg-6 mt-auto">
                                <label for="standar" class="h6">Standar</label>
                                <input type="text" class="form-control" id="standar" name="standar" value="<?= $standar['standar']; ?>">
                                <small></small>
                            </div>
                            <div class="col-12 col-lg-6 mt-5">
                                <h5>Apakah Aktif</h5>
                                <?php if ($standar['is_aktif'] == 1) { ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" id="aktif" type="radio" name="isactive" value="1" checked>
                                ...
                                <?php } else if ($standar['is_aktif'] == 0) { ?>
                                    <div class="form-check form-check-inline">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" id="tidakaktif" type="radio" name="isactive" value="0" checked>
                                        <label class="form-check-label" for="tidakaktif">Tidak aktif</label>
                                    </div>
                                <?php } else { ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" id="aktif<?= $value['uuid'] ?>" type="radio" name="isactive<?= $value['uuid'] ?>" value="1">
                                        <label class="form-check-label" for="aktif<?= $value['uuid'] ?>">Aktif</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" id="tidakaktif<?= $value['uuid'] ?>" type="radio" name="isactive<?= $value['uuid'] ?>" value="0">
                        ...
                        <div class="row justify-content-center">
                            <button type="submit" class="btn btn-primary mr-3">Ubah Standar</button>
