    ...
    <div class="table-container">
        <table>
            ...
            <?php foreach ($deskripsiTemuan as $key => $value) { ?>
                ...
                <tr>
                    <td rowspan="10" style="width: 15%;"><?= $value['kode_kriteria'] ?></td>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['deskripsi_temuan'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['kriteria'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['akibat'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['akar_penyebab'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['rekomendasi'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['tanggapan_auditi'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['rencana_perbaikan'] ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 25%; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['jadwal_perbaikan'] ?></td>
                    ...
                    <td style="width: 15%; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['penanggung_jawab_perbaikan'] ?></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 55%; text-align: start; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['rencana_pencegahan'] ?></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 25%; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['jadwal_pencegahan'] ?></td>
                    <td style="font-style: italic; text-align: start; font-weight: bold; background-color: #F2F2F2;  width: 15%; font-size: 12px; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Penanggung Jawab</td>
                    <td style="width: 15%; font-size: 12px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"><?= $value['penanggung_jawab_pencegahan'] ?></td>
                </tr>
